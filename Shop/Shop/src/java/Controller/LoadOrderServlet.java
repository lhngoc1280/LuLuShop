...
public class LoadOrderServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        ArrayList<Transaction> listOrder = trandb.getListTrans(logname);
        ArrayList<Status> stList = trandb.getStatusList();
            
            ses.setAttribute("stlist", stList);
        ses.setAttribute("listOrder", listOrder);
        if (rolename.equals("user")){
            response.sendRedirect(request.getContextPath() + "/views/viewOrder.jsp");
        } else if (rolename.equals("admin")){
//            response.sendRedirect(request.getContextPath() + "/views/xxx.jsp");
            response.sendRedirect(request.getContextPath() + "/views/viewTrans.jsp");
        }
