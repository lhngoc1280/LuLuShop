 ...
 * @author Admin
 */
@WebFilter(filterName = "HomeFilter", urlPatterns = {"/views/home.jsp", "/views/adminHome.jsp"})
public class HomeFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (ses.getAttribute("provinceList")==null){
            AddressDAO addDB = new AddressDAO();
            ses.setAttribute("provinceList", addDB.getProvinceList());
        }
        
        if (ses.getAttribute("pdb")==null){
