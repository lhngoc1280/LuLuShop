                    ...
                    <div class="col product_section clearfix">
                        ...
                        <div class="breadcrumbs d-flex flex-row align-items-center" style="margin-bottom: 20px">
                            <ul>
                                ...
                                <li class="active"><a href="<%=request.getContextPath()%>/cate?id=${requestScope.cid}"><i class="fa fa-angle-right" aria-hidden="true"></i>${requestScope.cname}</a></li>
                            </ul>
                        </div>
                            ...
                            <div class="sidebar_section">
                                ...
                                <ul class="sidebar_categories">
                                    <c:forEach items="${sessionScope.clist}" var="c">
                                        <li><a href="<%=request.getContextPath()%>/cate?id=${c.id}">${c.name}</a></li>
                                        </c:forEach>
                                </ul>
                            </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="product_sorting_container product_sorting_container_top">
                                            <ul class="product_sorting">
                                                <li>
                                                    ...
                                                    <ul class="sorting_type">
                                                        <li class="type_sorting_btn" >
                                                            <a href="<%=request.getContextPath()%>/cate?sort_by=default&id=${requestScope.cid}">
                                                                <span>Default Sorting</span>
                                                            </a>
                                                        </li>
                                                        <li class="type_sorting_btn" >
                                                            <a href="<%=request.getContextPath()%>/cate?sort_by=price&id=${requestScope.cid}">
                                                                <span>Price</span>
                                                            </a>
                                                        </li>
                                                        <li class="type_sorting_btn" >
                                                            <a href="<%=request.getContextPath()%>/cate?sort_by=name&id=${requestScope.cid}">
                                                                <span>Product Name</span>
                                                            </a>
                                                        </li>
                                                        <li class="type_sorting_btn" >
                                                            <a href="<%=request.getContextPath()%>/cate?sort_by=discount&id=${requestScope.cid}">
                                                                <span>Discount</span>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                ...
                                                <li>
                                                    ...
                                                    <ul class="sorting_num">
                                                        <c:if test="${requestScope.query!=null}">
                                                            <li><a href="<%=request.getContextPath()%>/cate?order_by=asc&${requestScope.query}"><span>Ascending</span></a></li>
                                                            <li><a href="<%=request.getContextPath()%>/cate?order_by=desc&${requestScope.query}"><span>Descending</span></a></li>
                                                            </c:if>
                                                ...
                                                <c:set value="${sessionScope.querycate}" var="querycate"/>
                                                <li>
                                                    <span>Show</span>
                                                    ...
                                                    <ul class="sorting_num">
                                                        <c:forEach items="${page.arrNrpp}" var="n">
                                                            <li class="num_sorting_btn" ><a href="<%=request.getContextPath()%>/cate?${querycate}&nrpp=${n}"><span>${n}</span></a></li>
                                                                    </c:forEach>
                                                    </ul>
                                                </li>
                                            </ul>
                                            <div class="pages d-flex flex-row align-items-center">
                                                <c:if test="${page.cp>1}">
                                                    <div class="page_next" style="padding-right: 30px"><a href="<%=request.getContextPath()%>/cate?${querycate}&cp=${page.cp-1}"><i class="fa fa-long-arrow-left" aria-hidden="true"></i></a></div>
                                                        </c:if>
                                                ...
                                                <div class="page_current">
                                                    ...
                                                    <ul class="page_selection">
                                                        <c:forEach begin="${1}" end="${page.np}" var="n">
                                                            <li><a href="<%=request.getContextPath()%>/cate?${querycate}&cp=${n}">${n}</a></li>
                                                            </c:forEach>
                                                    </ul>
                                                </div>
                                                <div class="page_total"><span>of</span>${page.np}</div>
                                                <c:if test="${page.cp<page.np}">
                                                    <div id="next_page" class="page_next"><a href="<%=request.getContextPath()%>/cate?${querycate}&cp=${page.cp+1}""><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></div>
                                                        </c:if>
                                            </div>
                                        ...
                                        <div class="product-grid">
                                            ...
                                            <c:forEach items="${requestScope.plist}" var="p" begin="${page.begin}" end="${page.end}">
                                                <div class="product-item men" id="${p.id}">
                                                    ...
                                                    <div class="product discount product_filter">
                                                        ...
                                                        <div class="red_button add_to_cart_button" ><a href="<%=request.getContextPath()%>/cart?pAddCart=${p.id}&quantity=1&urltext=category.jsp&qcate=${querycate}" >Add to cart</a></div>
                                                </div>
                                            </c:forEach>
                                        ...
                                        <div class="product_sorting_container product_sorting_container_bottom clearfix">
                                            ...
                                            <div class="pages d-flex flex-row align-items-center">
                                                ...
                                                <div class="page_total"><span>of</span>${page.np}</div>
                                                <c:if test="${page.cp<page.np}">
                                                    <div id="next_page_1" class="page_next"><a href="<%=request.getContextPath()%>/cate?${querycate}&cp=${page.cp+1}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></div>
                                                        </c:if>
                                            </div>
